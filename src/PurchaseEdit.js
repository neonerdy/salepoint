...
class PurchaseEdit extends Component
{
    ...
    updatePurchase = () => {
        ...
        if (isValid) {
            ...
            axios.put(config.serverUrl + '/api/purchase/update', purchase).then(response=> {
                            ...
                            <form>
                                ...
                                <div class="form-group  row"><label class="col-md-3 control-label" style={{textAlign:'right'}}>Purchase #</label>
                                    <div class="col-md-7 col-sm-12 required"><input type="text" class="form-control" 
                                        name="purchaseCode" onChange={this.onValueChange} value={this.state.purchaseCode}/>
                                    </div>
                                ...
                                <div class="form-group  row"><label class="col-md-3 control-label" style={{textAlign:'right'}}>Supplier Name</label>
                                    ...
                                    <div class="col-md-7 col-sm-12 required">
                                        <select class="form-control" name="supplierId" onChange={this.onValueChange} value={this.state.supplierId}>
                                ...
                                <div class="form-group  row"><label class="col-md-3 control-label" style={{textAlign:'right'}}>Purchase Date</label>
                                    <div class="input-group date col-md-7 col-sm-12 required">
                                        <input type="text" class="form-control" name="purchaseDate" onChange={this.onValueChange} value={moment(this.state.purchaseDate).format('MM/DD/YYYY')}/>
                                ...
                                <div class="form-group  row"><label class="col-md-3 control-label" style={{textAlign:'right'}}>Supplier Invoice #</label>
                                    <div class="col-md-7 col-sm-12"><input type="text" class="form-control" 
                                        name="supplierInvoice" onChange={this.onValueChange} value={this.state.supplierInvoice}/>
                                    </div>
                                ...
                                <div class="form-group  row"><label class="col-md-3 control-label" style={{textAlign:'right'}}>Payment Type</label>
                                     <div class="col-md-7 col-sm-12 required">
                                      ...
                                      <select class="form-control" name="paymentTypeId" onChange={this.onValueChange} value={this.state.paymentTypeId}>
                                ...
                                <div class="form-group  row"><label class="col-md-3 control-label" style={{textAlign:'right'}}>Payment Account</label>
                                     <div class="col-md-7 col-sm-12 required">
                                      <select class="form-control" name="paymentAccountId" onChange={this.onValueChange} value={this.state.paymentAccountId}>
                                ...
                                <div class="text-right">
                                        ...
                                        <button type="button" onClick={this.updatePurchase} class="btn btn-success"><i class="fa fa-check icon-white"></i> Update</button>
                                </div>
