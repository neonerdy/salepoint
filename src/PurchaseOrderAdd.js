...
class PurchaseOrderAdd extends Component
{
    ...
    savePurchaseOrder = () => {
        ...
        if (isValid) {
            ...
            axios.post(config.serverUrl + '/api/purchaseorder/save', purchaseOrder).then(response=> {
                            ...
                            <form autocomplete="off">
                                ...
                                <div class="form-group  row"><label class="col-md-3 control-label" style={{textAlign:'right'}}>Purchase Order #</label>
                                    <div class="col-md-7 col-sm-12 required"><input type="text" class="form-control" 
                                        name="purchaseOrderCode" onChange={this.onValueChange}/>
                                    </div>
                                    ...
                                    <div class="col-md-7 col-sm-12 required">
                                        <select name="supplierId" class="form-control" onChange={this.onValueChange}>
                                            ...
                                            {this.state.suppliers.map(s=> 
                                                <option value={s.id} key={s.id}>{s.supplierName}</option>
                                            )}
                                        </select>
                                ...
                                <div class="text-right">
                                        ...
                                        <button type="button" onClick={this.savePurchaseOrder} class="btn btn-success"><i class="fa fa-check icon-white"></i> Save</button>
                                </div>
