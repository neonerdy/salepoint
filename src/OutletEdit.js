...
class OutletEdit extends Component
{
    ...
    componentDidMount() {
        ...
        this.getOutletById(id);
    }


    getOutletById = (id) => {

        axios.get(config.serverUrl + '/api/outlet/getbyid/' + id).then(response=> {
            this.setState({
                id: response.data.id,
                ...
                outletEmployees: response.data.outletEmployees
            })
        })
    ...
    updateOutlet = () => {
        ...
        if (isValid) {
            ...
            axios.put(config.serverUrl + '/api/outlet/update', outlet).then(response=> {
                            ...
                            <form>
                                ...
                                <div class="form-group  row"><label class="col-md-3 control-label" style={{textAlign:'right'}}>Outlet Name</label>
                                    <div class="col-md-7 col-sm-12 required">
                                        <input type="text" class="form-control" name="outletName" onChange={this.onValueChange} value={this.state.outletName}/>
                                    </div>
                                ...
                                <div class="form-group  row"><label class="col-md-3 control-label" style={{textAlign:'right'}}>Address</label>
                                    <div class="col-md-7 col-sm-12 required">
                                        <input type="text" class="form-control" name="address" onChange={this.onValueChange} value={this.state.address}/>
                                    </div>
                                ...
                                <div class="form-group  row"><label class="col-md-3 control-label" style={{textAlign:'right'}}>City</label>
                                    <div class="col-md-7 col-sm-12 required">
                                        <input type="text" class="form-control" name="city" onChange={this.onValueChange} value={this.state.city}/>
                                    </div>
                                ...
                                <div class="form-group  row"><label class="col-md-3 control-label" style={{textAlign:'right'}}>Province</label>
                                    <div class="col-md-7 col-sm-12 required">
                                        <input type="text" class="form-control" name="province" onChange={this.onValueChange} value={this.state.province}/>
                                    </div>
                                ...
                                <div class="form-group  row"><label class="col-md-3 control-label" style={{textAlign:'right'}}>Phone</label>
                                    <div class="col-md-7 col-sm-12 required">
                                        <input type="text" class="form-control" name="phone" onChange={this.onValueChange} value={this.state.phone}/>
                                    </div>
                                ...
                                <div class="form-group  row"><label class="col-md-3 control-label" style={{textAlign:'right'}}>Manager</label>
                                    <div class="col-md-7 col-sm-12 required">
                                        <input type="text" class="form-control" name="manager" onChange={this.onValueChange} value={this.state.manager}/>
                                    </div>
                                ...
                                <div class="form-group  row"><label class="col-md-3 control-label" style={{textAlign:'right'}}>Opening Date</label>
                                    <div class="input-group date col-md-7 col-sm-12 required">
                                        <input type="text" class="form-control"  
                                            name="openingDate" onChange={this.onValueChange} value={moment(this.openingDate).format('MM/DD/YYYY')}/>
                                ...
                                <div class="text-right">
                                        ...
                                        <button type="button" onClick={this.updateOutlet} class="btn btn-success"><i class="fa fa-check icon-white"></i> Update</button>
                                    </div>
