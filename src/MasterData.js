...
class MasterData extends Component
{
   ...
   /* PRODUCT CATEGORY */
    ...
    deletePaymentType = (id) => {
     ...
     getExpenseGroups = () => {
        axios.get(config.serverUrl + '/api/expensegroup/getall').then(response=> {
            this.setState({
                expenseGroups: response.data
            })
        })
    }
    ...
    addExpenseGroup = () => {
        this.props.history.push('/add-expense-group');
    }

    
    editExpenseGroup = (id) => {
        this.props.history.push('/edit-expense-group/' + id);
    }

    onDeleteExpenseGroup = (expenseGroupId, expenseGroupName) => {
        this.setState({
    ...
    deleteExpenseGroup = (id) => {
        ...
        axios.delete(config.serverUrl + '/api/expensegroup/delete/' + id).then(response=> {
            this.getExpenseGroups();
        })
    }
     ...
     getSettings = () => {
        axios.get(config.serverUrl + '/api/setting/getall').then(response=> {
            this.setState({
    ...
    render() {
        ...
        return(
           ...
           <div id="page-wrapper" class="gray-bg">
              ...
              <div id="deleteExpenseGroup" class="modal fade" role="dialog">
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                          ...
                          <div class="modal-header">
                            <h4>Delete Expense Group</h4>
                          </div>
                          <div class="modal-body">
                          Are you sure want to delete '{this.state.expenseGroupName}' ?
                          </div>

                          <div class="modal-footer">
                            <a class="btn btn-link text-left" href="#" data-dismiss="modal">Cancel</a>
                            <button class="btn btn-label btn-danger" onClick={()=>this.deleteExpenseGroup(this.state.expenseGroupId)} data-dismiss="modal">
                                <label><i class="ti-check"></i></label> YES</button>
                          </div>
                        ...
                        <div class="title-action">
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu" x-placement="bottom-start">
                                    ...
                                    <li><a class="dropdown-item" onClick={this.addExpenseGroup}>Expense Group</a></li>
                                </ul>
                             </div>
                         </div>
                </div>        
        ...
        <div class="col-lg-4">
            ...
            <div class="col-lg-4">
                ...
                <div class="col-lg-4">
                        ...
                        {this.state.expenseGroups.map(eg=> 
                        <li key={eg.id}>
                            <span class="m-l-xs">{eg.groupName}</span>
                            <small class="float-right">
                                <a onClick={()=>this.editExpenseGroup(eg.id)}><i class="fa fa-edit"></i></a> &nbsp;&nbsp;
                                 <a data-toggle="modal" data-target="#deleteExpenseGroup" 
                                    onClick={()=>this.onDeleteExpenseGroup(eg.id, eg.groupName)}><i class="fa fa-trash"></i></a>
                                    &nbsp;&nbsp;
                            </small>
                        </li>
                        )}
                ...
                <div class="col-lg-4">
                    ...
                    <div class="ibox-content">
                    <h2>Settings ({this.state.settings.length})</h2>
                    ...
                    <li>
                        <span class="m-l-xs">{s.settingName}</span>
                        <small class="float-right">
                             <a onClick={()=>this.editSetting(s.id)}><i class="fa fa-edit"></i></a> &nbsp;&nbsp;
                        </small>
                    </li>
                    )}
