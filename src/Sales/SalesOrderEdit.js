...
class SalesOrderEdit extends Component
{
    ...
    updateSalesOrder = () => {
        ...
        if (isValid) {
            ...
            axios.put(config.serverUrl + '/api/salesorder/update', salesOrder).then(response=> {
                            ...
                            <form>
                                ...
                                <div class="form-group  row"><label class="col-md-3 control-label" style={{textAlign:'right'}}>Sales Order #</label>
                                    <div class="col-md-7 col-sm-12 required"><input type="text" class="form-control" 
                                        name="salesOrderCode" onChange={this.onValueChange} value={this.state.salesOrderCode}/>
                                    </div>
                                ...
                                <div class="text-right">
                                        ...
                                        <button type="button" onClick={this.updateSalesOrder} class="btn btn-success"><i class="fa fa-check icon-white"></i> Update</button>
                                </div>
